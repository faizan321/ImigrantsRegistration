...
public final class DashboardRoleItemBinding implements ViewBinding {
  @NonNull
  ...
  private DashboardRoleItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView checkImage,
  ...
  @NonNull
  public static DashboardRoleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DashboardRoleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dashboard_role_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DashboardRoleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DashboardRoleItemBinding((LinearLayout) rootView, checkImage, policyTypeCard,
          title);
    }
